...
class TongCheng():
    ...
    @property
    def ele_t_name(self):
        ele = self.driver.find_element_by_xpath("/html/body/div[3]/div[2]/div[1]/div[3]/div[2]/div/ul/li/div[2]/div[2]/span[2]/a[1]")
        return ele

    #同城帖子里帖子标题
    @property
    def ele_t_title(self):
        ele = self.driver.find_element_by_xpath("/html/body/div[3]/div[2]/div[1]/div[3]/div[2]/div/ul/li/div[2]/div[1]/a")
        return ele

    #同城帖子里发帖人所在小组名称
    @property
    def ele_t_class(self):
        ele = self.driver.find_element_by_xpath("/html/body/div[3]/div[2]/div[1]/div[3]/div[2]/div/ul/li/div[2]/div[2]/span[1]/a")
        return ele

    #同城帖子里帖子回复数
    @property
    def ele_t_huifu(self):
        ele = self.driver.find_element_by_xpath("/html/body/div[3]/div[2]/div[1]/div[3]/div[2]/div/ul/li/div[2]/div[2]/span[2]/a[2]")
        return ele
    ...
    @property
    def ele_l_name(self):
        ele = self.driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[2]/div[1]/div[2]/div/ul/li/span[2]/span[1]/a')
        return ele

    # 唠唠叨叨里第一个唠叨的评价
    @property
    def ele_l_ping(self):
        ele = self.driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[2]/div[1]/div[2]/div/ul/li/span[2]/span[3]/a')
        return ele

    # 唠唠叨叨里第一个唠叨的内容
    @property
    def ele_l_laodao(self):
        ele = self.driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[2]/div[1]/div[2]/div/ul/li/span[2]/span[2]/p')
        return ele
